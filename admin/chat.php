...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .user-item { display: flex; align-items: center; gap: 12px; padding: 12px; cursor: pointer; border-radius: 12px; transition: background 0.2s; }
...
<body>
    ...
    <script>
        ...
        function startConversation(userId) { window.location.href = `../user/api/start_conversation.php?broker_id=${userId}`; }
