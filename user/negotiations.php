...
// Jobs show only commission, no deposit
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'accept_proposal') {
        ...
        $conn->query("
            ...
            'Seller has accepted the commission proposal for listing \"{$listing['title']}\". Ready for approval.', 
            '/broker_system/admin/negotiations.php', NOW())
        ");
        
        $message = "You have accepted the proposal! The admin will now review and approve your listing.";
...
<style>
    ...
    .negotiations-container { max-width: 1000px; margin: 0 auto; }
    ...
    .listing-title { font-size: 18px; font-weight: 700; color: var(--dark); }
    .listing-price { font-size: 20px; font-weight: 700; color: var(--primary); }
    ...
    .close-modal { cursor: pointer; font-size: 28px; color: var(--gray); transition: color 0.3s; }
    .close-modal:hover { color: var(--danger); }
    .form-group { margin-bottom: 20px; }
    .form-group label { display: block; margin-bottom: 8px; font-weight: 600; color: var(--dark); }
    .form-group textarea { width: 100%; padding: 12px; border: 1px solid var(--border); border-radius: 12px; resize: vertical; font-family: inherit; }
    ...
    @media (max-width: 768px) {
        ...
        .proposal-details { flex-direction: column; gap: 16px; }
...
<div class="negotiations-container">
    ...
    <div class="stats-grid">
        <div class="stat-card"><div class="stat-value"><?php echo $stats['total']; ?></div><div class="stat-label">Total Negotiations</div></div>
        <div class="stat-card"><div class="stat-value"><?php echo $stats['pending']; ?></div><div class="stat-label">Pending Response</div></div>
            ...
            <div class="negotiation-card">
                <div class="card-header">
                    <div>
                        ...
                        <div style="font-size: 12px; color: var(--gray); margin-top: 4px;"><?php echo ucfirst($neg['type']); ?> Listing</div>
                    </div>
                    <div>
                        <div class="listing-price"><?php echo formatMoney($neg['price']); ?></div>
                        <div class="status-badge <?php echo $status_class; ?>" style="margin-top: 8px;"><?php echo $status_text; ?></div>
                    </div>
                </div>
                
                <?php if ($neg['proposed_commission']): ?>
                <div class="proposal-box">
                    <div class="proposal-title"><i class="fas fa-file-signature"></i> Commission Proposal</div>
                    ...
                    <div class="admin-note"><i class="fas fa-comment-dots"></i> <strong>Admin Note:</strong> <?php echo htmlspecialchars($neg['admin_notes']); ?></div>
                    <?php endif; ?>
                </div>
                <?php endif; ?>
...
<div id="acceptModal" class="modal">
    <div class="modal-content">
        ...
        <div style="background: #fef3c7; padding: 16px; border-radius: 12px; margin-bottom: 20px;">
            <p><strong>⚠️ Important:</strong> By accepting this proposal, you agree to the terms. <?php if (!$is_job): ?>You will need to pay the deposit amount to publish your listing.<?php endif; ?></p>
        </div>
        <form method="POST">
